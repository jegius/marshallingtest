...
public class Main {
    public static void main(String[] args) {
        ...
        Product one = new Product("Phone", 12000, adressOne,"Super Phone");
        Product two = new Product("TV", 22000, adressTwo, "Super TV");
        Product three = new Product("NoteBook", 42000, adressThree, "Super Nootebook");
        Product four = new Product("Split system", 52000,  adressThree, "Super Split System");
